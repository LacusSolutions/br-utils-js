...
namespace cnpjVal {
  ...
  export const InputTypeError = BaseCnpjValidatorInputTypeError;
  export const OptionsTypeError = BaseCnpjValidatorOptionsTypeError;
  export const OptionTypeInvalidException = BaseCnpjValidatorOptionTypeInvalidException;
