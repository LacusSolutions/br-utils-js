...
describe('package distributions', (): void => {
  ...
  describe('UMD', (): void => {
    describe.each(['utils.js', 'utils.min.js'])('file `%s`', (fileName): void => {
  ...
  describe('ES Module', (): void => {
    ...
    describe('file `index.d.ts`', (): void => {
      ...
      it('exports `SequenceType` type as named', (): void => {
        expect(exportedTypes).toContain('SequenceType');
      });

      it('declares `Nullable` type', (): void => {
        expect(content).toContain('type Nullable');
      });

      it('exports `Nullable` type as named', (): void => {
