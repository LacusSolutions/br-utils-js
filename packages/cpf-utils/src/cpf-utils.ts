 ...
 *
 *
 * @typedef {import('./cpf-formatter').CpfFormatterOptionsHiddenRangeInvalidException} CpfFormatterOptionsHiddenRangeInvalidException
 *
 *
 * @typedef {import('./cpf-generator').CpfGeneratorOptionsTypeError} CpfGeneratorOptionsTypeError
 *
 *
 * @typedef {import('./cpf-generator').CpfGeneratorOptionPrefixInvalidException} CpfGeneratorOptionPrefixInvalidException
 *
 *
 * @typedef {import('./cpf-validator').CpfValidatorInputTypeError} CpfValidatorInputTypeError
 */
