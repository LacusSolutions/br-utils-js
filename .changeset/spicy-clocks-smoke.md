...
- **`generateRandomSequence(size, type)`** — Generates random sequences of given length; `type` is `'numeric'` (0–9), `'alphabetic'` (A–Z), or `'alphanumeric'` (0–9, A–Z). Exported type: `CnpjType`.
